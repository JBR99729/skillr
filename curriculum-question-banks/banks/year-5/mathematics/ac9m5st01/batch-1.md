...
# AC9M5ST01 — Year 5 Mathematics digital question bank

## 60-second Quick Read

- **Key idea:** This Year 5 skill is about acquire, validate and represent data for nominal and ordinal categorical and discrete numerical variables, to address a question of interest or purpose using software including spreadsheets; discuss and report on data distributions in terms of highest frequency (mode) and shape, in the context of the data.
...
### P01 — Classify each variable as nominal ordinal or

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Classify each variable as nominal, ordinal or discrete numerical: favourite colour, rating 1-5, number of siblings.
...
**Coverage:** Online Year 5 task assessing classify each variable nominal ordinal discrete numerical favourite.
...
### P03 — Find the mode of 3 5 5

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find the mode of: 3, 5, 5, 6, 7, 7, 7, 9.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find mode.

### P04 — Can a data set have more than

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Can a data set have more than one mode? Give an example.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing data have more than mode example.

### P05 — Complete the structured template for a survey

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the structured template for a survey question about lunch choices with balanced answer options.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing survey about lunch choices balanced.
...
### P09 — A spreadsheet date is typed as text

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A spreadsheet date is typed as text. Why might that be a problem for data validation?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing spreadsheet date typed text might problem data validation.

### P10 — Identify the mode in a bar chart

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Identify the mode in a bar chart where cats = 6, dogs = 9, birds = 3, fish = 9.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing identify mode chart cats dogs birds fish.

### P11 — Describe the shape of a data distribution

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Describe the shape of a data distribution where most results are low and a few are high.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing describe shape data distribution most results high.

### P12 — Complete the structured template for a table

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the structured template for a table for recording outcomes of 30 dice rolls.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing table recording outcomes dice rolls.
...
### P14 — Write an unbiased survey question about preferred

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write an unbiased survey question about preferred playground equipment.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write unbiased survey about preferred playground equipment.

### P15 — Rewrite this biased question Don t you

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Rewrite this biased question: 'Don't you agree maths games are the best activity?'

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing rewrite this biased agree maths games best activity.
...
### P17 — Collect ordinal data using a 1 5

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Collect ordinal data using a 1-5 confidence scale. How would you report the mode?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing collect ordinal data confidence scale would report mode.

## Tier 2 — Core skill practice

### P18 — A data set has no repeated values

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A data set has no repeated values. What can you say about the mode?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing data repeated values about mode.
...
### P20 — Describe a data distribution from a dot

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Describe a data distribution from a dot plot with two clusters.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing describe data distribution plot clusters.
...
### P22 — Complete the structured template for a chance

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the structured template for a chance experiment and record the frequency of each outcome.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing chance experiment record frequency each outcome.

### P23 — Report findings from a small data table

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Report findings from a small data table using mode and shape.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing report findings small data table mode shape.
...
**Coverage:** Online Year 5 task assessing online version diagram model best represents data variables.
...
**Question:** Complete the missing entries in a four-row table for a data variables, validation, displays, mode and distribution shape problem.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing missing entries four table data variables validation displays.
...
**Question:** Solve a multi-step word problem involving data variables, validation, displays, mode and distribution shape and one distractor number that is not needed.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing solve multi step word problem involving data variables.
...
### P44 — Write a short investigation connected to data

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write a short investigation connected to data variables, validation, displays, mode and distribution shape and describe what data or measurements you would need.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write short investigation connected data variables validation displays.

### P45 — Solve a problem that combines data variables

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Solve a problem that combines data variables, validation, displays, mode and distribution shape with another Year 5 maths idea.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing solve problem combines data variables validation displays mode.
...
**Question:** Identify the most likely trap in a test question about data variables, validation, displays, mode and distribution shape, then avoid it in your solution.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing identify most likely trap test about data variables.
...
**Coverage:** Online Year 5 task assessing mini test about data variables validation displays mode.
...
**Question:** Write your own high-quality challenge question for AC9M5ST01, then solve it fully.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write your high quality challenge ac9m5st01 solve fully.

### P49 — Beginner digital question Classify each variable as

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Classify each variable as nominal, ordinal or discrete numerical: favourite colour, rating 1-5, number of siblings.
...
### P51 — Complete the answer box Find the mode

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: Find the mode of: 3, 5, 5, 6, 7, 7, 7, 9.
...
### P52 — Match or choose Can a data set

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Can a data set have more than one mode? Give an example.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match data have more than mode example.
...
### P57 — Match or choose A spreadsheet date is

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: A spreadsheet date is typed as text. Why might that be a problem for data validation?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match spreadsheet date typed text might problem data.
...
### P59 — Beginner digital question Describe the shape of

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Describe the shape of a data distribution where most results are low and a few are high.
...
**Question:** Use the on-screen options: Complete the structured template for a table for recording outcomes of 30 dice rolls.
...
### P62 — Match or choose Write an unbiased survey

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Write an unbiased survey question about preferred playground equipment.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match write unbiased survey about preferred playground equipment.
...
### P65 — Use the on screen options Collect ordinal

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Collect ordinal data using a 1-5 confidence scale. How would you report the mode?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing collect ordinal data confidence scale would report mode.

### P66 — Complete the answer box A data set

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: A data set has no repeated values. What can you say about the mode?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing data repeated values about mode.

### P67 — Match or choose Choose between a bar
...
**Question:** Match or choose: Choose between a bar chart, column graph or dot plot for discrete numerical data. Justify.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match between chart column graph plot discrete numerical.
...
**Question:** Use the on-screen options: Complete the structured template for a chance experiment and record the frequency of each outcome.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing chance experiment record frequency each outcome.

### E03 — Complete the answer box Report findings from

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: Report findings from a small data table using mode and shape.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing report findings small data table mode shape.

### E04 — Match or choose Explain why the context

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Explain why the context of data matters when drawing conclusions.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match context data matters when drawing conclusions.

### E05 — Find the mode of 4 6 6

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find the mode of 4, 6, 6, 7 and 8.
...
**Question:** Multi-step online task: Complete the structured template for a realistic Year 5 context for data variables, validation, displays, mode and distribution shape where a careless student might choose the wrong operation. Solve it. Use two steps and choose the matching reasoning.
...
**Question:** Multi-step online task: Complete the missing entries in a four-row table for a data variables, validation, displays, mode and distribution shape problem.
...
**Question:** Multi-step online task: Explain the key vocabulary in data variables, validation, displays, mode and distribution shape using an example and a non-example. Use two steps and choose the matching reasoning.
...
**Question:** Multi-step online task: Find all possible answers to a data variables, validation, displays, mode and distribution shape puzzle with more than one solution, and explain how you know you found all. Use two steps and choose the matching reasoning.
...
**Question:** Multi-step online task: Identify the most likely trap in a test question about data variables, validation, displays, mode and distribution shape, then avoid it in your solution. Use two steps and choose the matching reasoning.
