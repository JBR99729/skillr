...
# AC9M5N03 — Year 5 Mathematics digital question bank

## 60-second Quick Read

- **Key idea:** This Year 5 skill is about compare and order fractions with the same and related denominators including mixed numerals, applying knowledge of factors and multiples; represent these fractions on a number line.
...
### P01 — Order these fractions from smallest to largest
...
**Question:** Order these fractions from smallest to largest: 1/2, 3/4, 5/8, 2/4.
...
**Coverage:** Online Year 5 task assessing order fractions smallest largest.

### P02 — Place 1 5 and 2 10 on
...
**Question:** Place 1/5 and 2/10 on parallel number lines. What do you notice?
...
**Coverage:** Online Year 5 task assessing place parallel number lines notice.
...
### P04 — Convert 1 3 4 to an improper

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Convert 1 3/4 to an improper fraction and place it on a number line from 1 to 2.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing convert improper fraction place number line.
...
### P06 — Write three fractions equivalent to 2 3

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write three fractions equivalent to 2/3 using denominators less than 30.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write three fractions equivalent denominators less than.

### P07 — Order 7 8 3 4 5 6

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Order 7/8, 3/4, 5/6 and 1/2. Explain your comparison strategy.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. The order must be complete and use the direction requested in the prompt.

**Coverage:** Online Year 5 task assessing order your comparison strategy.
...
### P10 — Find a fraction between 1 4 and

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find a fraction between 1/4 and 1/2. Show it on a number line.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find fraction between show number line.
...
### P14 — Create two different fractions that are at

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Create two different fractions that are at the same point as 3/5 on a number line.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing create different fractions same point number line.

### P15 — Use factors and multiples to compare 2

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use factors and multiples to compare 2/3 and 5/9.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing factors multiples compare.

### P16 — Place 0 1 4 3 4 1

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Place 0, 1/4, 3/4, 1 1/4 and 1 3/4 on a number line.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing place number line.
...
### P20 — Write these as improper fractions 1 2

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write these as improper fractions: 1 2/5, 3 1/2, 2 3/4.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write improper fractions.

### P21 — Write these as mixed numerals 13 5

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write these as mixed numerals: 13/5, 17/4, 22/6.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write mixed numerals.

### P22 — Use a diagram to prove 4 6

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use a diagram to prove 4/6 is equivalent to 2/3.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing diagram prove equivalent.

### P23 — Find two fractions with related denominators where

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find two fractions with related denominators where the larger numerator does not mean the larger fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find fractions related denominators larger numerator does mean.
...
### P25 — Order 5 6 7 12 3 4

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Order 5/6, 7/12, 3/4 and 11/18 using common or related denominators.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. The order must be complete and use the direction requested in the prompt.

**Coverage:** Online Year 5 task assessing order common related denominators.

### P26 — Order 1 1 3 5 4 1
...
**Question:** Order 1 1/3, 5/4, 1 2/6 and 7/6 from left to right on a number line from 1 to 1 1/2.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing order left right number line.
...
### P28 — Find two fractions between 3 5 and

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find two fractions between 3/5 and 4/5 with denominators related to 10 or 20.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find fractions between denominators related.

### P29 — A student says 9 12 is larger

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A student says 9/12 is larger than 5/6 because 9 is larger than 5. Correct the comparison.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing says larger than because larger than correct comparison.

### P30 — Convert 2 3 8 19 8 and

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Convert 2 3/8, 19/8 and 2 1/2 to a common form, then order them.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. The order must be complete and use the direction requested in the prompt.

**Coverage:** Online Year 5 task assessing convert common form order them.

### P31 — Match 2 3 5 6 and 9
...
**Question:** Match 2/3, 5/6 and 9/12 to their positions on parallel thirds, sixths and twelfths number lines.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing match their positions parallel thirds sixths twelfths number.
...
### P33 — Find the missing numerator 18 is equivalent

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find the missing numerator: ___/18 is equivalent to 5/6. Then write a larger equivalent fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find missing numerator equivalent write larger equivalent fraction.
...
### P35 — Write three improper fractions equivalent to mixed

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write three improper fractions equivalent to mixed numerals between 1 and 2.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write three improper fractions equivalent mixed numerals between.
...
### P37 — Order 13 10 1 1 5 6

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Order 13/10, 1 1/5, 6/5 and 1 3/10. Explain the trap.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. The order must be complete and use the direction requested in the prompt.

**Coverage:** Online Year 5 task assessing order trap.
...
### P39 — Find a fraction with denominator 24 that

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find a fraction with denominator 24 that is between 2/3 and 3/4.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find fraction denominator between.
...
### P42 — Select the set of four fractions where

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Select the set of four fractions where the largest numerator is not the largest fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing four fractions largest numerator largest fraction.
...
### P44 — Use benchmark fractions 0 1 2 and

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use benchmark fractions 0, 1/2 and 1 to compare 5/12, 7/8 and 3/6.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing benchmark fractions compare.
...
### P46 — Order 3 8 5 8 7 16

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative.

**Question:** Order 3/8, 5/8, 7/16 and 1/2 from left to right on a number line.
...
### P48 — Select the tricky fraction comparison question that

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Select the tricky fraction comparison question that uses related denominators, then enter the answer.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing tricky fraction comparison uses related denominators enter.

### P49 — Beginner digital question Order these fractions from

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Order these fractions from smallest to largest: 1/2, 3/4, 5/8, 2/4.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. The order must be complete and use the direction requested in the prompt.

**Coverage:** Online Year 5 task assessing order fractions smallest largest.

### P50 — Use the on screen options Place 1

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Place 1/5 and 2/10 on parallel number lines. What do you notice?
...
### P52 — Match or choose Convert 1 3 4

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative.

**Question:** Match or choose: Convert 1 3/4 to an improper fraction and place it on a number line from 1 to 2.
...
**Coverage:** Online Year 5 task assessing match convert improper fraction place number line.
...
### P54 — Beginner digital question Write three fractions equivalent

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Write three fractions equivalent to 2/3 using denominators less than 30.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write three fractions equivalent denominators less than.

### P55 — Use the on screen options Order 7

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Order 7/8, 3/4, 5/6 and 1/2. Explain your comparison strategy.
...
### P57 — Match or choose Which mixed numeral is

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Which mixed numeral is larger: 2 1/3 or 2 2/6? Explain.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match mixed numeral larger.
...
### P62 — Match or choose Create two different fractions

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Create two different fractions that are at the same point as 3/5 on a number line.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match create different fractions same point number line.
...
### P64 — Beginner digital question Place 0 1 4

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Place 0, 1/4, 3/4, 1 1/4 and 1 3/4 on a number line.
...
### P67 — Match or choose Find the missing denominator

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Find the missing denominator: 2/5 = 6/___. Explain your reasoning.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match find missing denominator your reasoning.
...
### E01 — Beginner digital question Write these as mixed

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Write these as mixed numerals: 13/5, 17/4, 22/6.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write mixed numerals.

### E02 — Use the on screen options Use a

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Use a diagram to prove 4/6 is equivalent to 2/3.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing diagram prove equivalent.

### E03 — Complete the answer box Find two fractions

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: Find two fractions with related denominators where the larger numerator does not mean the larger fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find fractions related denominators larger numerator does mean.

### E04 — Match or choose Explain how a fraction

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Explain how a fraction wall and a number line show fractions differently.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match fraction wall number line show fractions differently.
...
**Coverage:** Online Year 5 task assessing order common related denominators check common trap before.

### E07 — Multi step online task Order 1 1

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative.

**Question:** Multi-step online task: Order 1 1/3, 5/4, 1 2/6 and 7/6 from left to right on a number line from 1 to 1 1/2.
...
**Coverage:** Online Year 5 task assessing convert common form order them check common trap.

### E12 — Multi step online task Match 2 3

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: Match 2/3, 5/6 and 9/12 to their positions on parallel thirds, sixths and twelfths number lines.
...
**Coverage:** Online Year 5 task assessing reasoning check order trap interpret story context.
...
### E22 — Multi step online task Choose the greater

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: Choose the greater amount: 11/12 of a pizza or 5/6 of the same pizza. select the method steps. Use two steps and choose the matching reasoning.
...
### E27 — Multi step online task Order 3 8

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative.

**Question:** Multi-step online task: Order 3/8, 5/8, 7/16 and 1/2 from left to right on a number line.
...
### E30 — Order 5 6 7 9 11 12

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Order 5/6, 7/9, 11/12 and 3/4 using related denominator reasoning.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing order related denominator reasoning.
