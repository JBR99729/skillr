...
# AC9M5A01 — Year 5 Mathematics digital question bank

## 60-second Quick Read

- **Key idea:** This Year 5 skill is about recognise and explain the connection between multiplication and division as inverse operations and use this to develop families of number facts.
...
### P01 — Write the four fact family number sentences

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write the four fact-family number sentences for 6, 8 and 48.
...
**Coverage:** Online Year 5 task assessing write four fact family number sentences.

### P02 — Use an array to show 7 x
...
**Question:** Use an array to show 7 x 4 = 28 and the related division facts.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing array show related division facts.

### P03 — Solve 240 divided by 20 by thinking

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Solve 240 divided by 20 by thinking 20 x ___ = 240.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing solve divided thinking.
...
### P07 — Write a fact family for 11 12

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write a fact family for 11, 12 and 132.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write fact family.
...
### P09 — Use a multiplication table to solve 96

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use a multiplication table to solve 96 divided by 12.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing multiplication table solve divided.

### P10 — Find the related multiplication for 84 divided

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find the related multiplication for 84 divided by 7 = 12.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find related multiplication divided.
...
### P12 — Solve 15 x 180 using division

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Solve 15 x ___ = 180 using division.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing solve division.
...
### P14 — Find all four facts for 9 13

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find all four facts for 9, 13 and 117.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find four facts.

### P15 — A box has 144 pencils in 12

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A box has 144 pencils in 12 equal packs. Use inverse operations to find pencils per pack.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing pencils equal packs inverse operations find pencils pack.

### P16 — Write a division story for 56 divided

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write a division story for 56 divided by 8 and its related multiplication story.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write division story divided related multiplication story.

### P17 — Use inverse operations to check whether 16

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use inverse operations to check whether 16 x 14 = 224.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing inverse operations check whether.

## Tier 2 — Core skill practice

### P18 — Find the missing number divided by 9

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find the missing number: ___ divided by 9 = 23.
...
### P20 — Sort these into the same fact family
...
**Question:** Sort these into the same fact family: 5 x 14, 70 divided by 5, 70 divided by 14, 14 x 5.
...
**Coverage:** Online Year 5 task assessing sort into same fact family divided divided.

### P21 — Complete the structured template for a fact

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the structured template for a fact family using a product greater than 200.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing fact family product greater than.

### P22 — A student writes 36 divided by 4

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A student writes 36 divided by 4 = 8. Use inverse operations to check and correct it.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing writes divided inverse operations check correct.
...
### P24 — Why are inverse operations useful for checking

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Why are inverse operations useful for checking answers? Give an example.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing inverse operations useful checking answers example.
...
**Coverage:** Online Year 5 task assessing online version diagram model best represents multiplication division.
...
**Question:** Complete the missing entries in a four-row table for a multiplication and division as inverse operations; fact families problem.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing missing entries four table multiplication division inverse operations.
...
**Question:** Solve a multi-step word problem involving multiplication and division as inverse operations; fact families and one distractor number that is not needed.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing solve multi step word problem involving multiplication division.
...
### P44 — Write a short investigation connected to multiplication

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write a short investigation connected to multiplication and division as inverse operations; fact families and describe what data or measurements you would need.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write short investigation connected multiplication division inverse operations.

### P45 — Solve a problem that combines multiplication and

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Solve a problem that combines multiplication and division as inverse operations; fact families with another Year 5 maths idea.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing solve problem combines multiplication division inverse operations fact.
...
**Question:** Identify the most likely trap in a test question about multiplication and division as inverse operations; fact families, then avoid it in your solution.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing identify most likely trap test about multiplication division.
...
**Coverage:** Online Year 5 task assessing mini test about multiplication division inverse operations fact.
...
**Question:** Write your own high-quality challenge question for AC9M5A01, then solve it fully.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write your high quality challenge ac9m5a01 solve fully.

### P49 — Beginner digital question Write the four fact

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Write the four fact-family number sentences for 6, 8 and 48.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write four fact family number sentences.

### P50 — Use the on screen options Use an

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Use an array to show 7 x 4 = 28 and the related division facts.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing array show related division facts.

### P51 — Complete the answer box Solve 240 divided

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: Solve 240 divided by 20 by thinking 20 x ___ = 240.
...
### P52 — Match or choose Find the missing number

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Find the missing number: 17 x ___ = 221. Which inverse operation helps?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match find missing number inverse operation helps.
...
### P55 — Use the on screen options Write a

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Write a fact family for 11, 12 and 132.
...
### P57 — Match or choose Use a multiplication table

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Use a multiplication table to solve 96 divided by 12.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match multiplication table solve divided.
...
### P60 — Use the on screen options Solve 15

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Solve 15 x ___ = 180 using division.
...
### P62 — Match or choose Find all four facts

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Match or choose: Find all four facts for 9, 13 and 117.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match find four facts.
...
### P64 — Beginner digital question Write a division story

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Write a division story for 56 divided by 8 and its related multiplication story.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write division story divided related multiplication story.

### P65 — Use the on screen options Use inverse

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Use inverse operations to check whether 16 x 14 = 224.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing inverse operations check whether.

### P66 — Complete the answer box Find the missing

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: Find the missing number: ___ divided by 9 = 23.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find missing number divided.

### P67 — Match or choose Explain how knowing 12

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Explain how knowing 12 x 12 helps solve 144 divided by 12.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match knowing helps solve divided.

### P68 — Select the best answer Sort these into

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Select the best answer: Sort these into the same fact family: 5 x 14, 70 divided by 5, 70 divided by 14, 14 x 5.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing best sort into same fact family divided divided.
...
**Question:** Beginner digital question: Complete the structured template for a fact family using a product greater than 200.
...
**Question:** Use the on-screen options: A student writes 36 divided by 4 = 8. Use inverse operations to check and correct it.
...
### E04 — Match or choose Why are inverse operations

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Match or choose: Why are inverse operations useful for checking answers? Give an example.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match inverse operations useful checking answers example.

### E05 — Complete the fact family for 7 x

**Type:** Short response

**Question:** Complete the fact family for 7 x 8 = 56.
...
**Question:** Multi-step online task: Complete the structured template for a realistic Year 5 context for multiplication and division as inverse operations; fact families where a careless student might choose the wrong operation. Solve it. Use two steps and choose the matching reasoning.
...
**Question:** Multi-step online task: Complete the missing entries in a four-row table for a multiplication and division as inverse operations; fact families problem.
...
**Question:** Multi-step online task: Explain the key vocabulary in multiplication and division as inverse operations; fact families using an example and a non-example. Use two steps and choose the matching reasoning.
...
**Question:** Multi-step online task: Find all possible answers to a multiplication and division as inverse operations; fact families puzzle with more than one solution, and explain how you know you found all. Use two steps and choose the matching reasoning.
...
**Question:** Multi-step online task: Identify the most likely trap in a test question about multiplication and division as inverse operations; fact families, then avoid it in your solution. Use two steps and choose the matching reasoning.
...
### E30 — Given 9 x 14 126 match four

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Given 9 x 14 = 126, match four related multiplication/division equations.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing given match four related multiplication division equations.
