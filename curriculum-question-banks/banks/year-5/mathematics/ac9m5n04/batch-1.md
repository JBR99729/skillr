...
# AC9M5N04 — Year 5 Mathematics digital question bank

## 60-second Quick Read

- **Key idea:** This Year 5 skill is about recognise that 100% represents the complete whole and use percentages to describe, represent and compare relative size; connect familiar percentages to their decimal and fraction equivalents.
...
### P03 — Match each percentage to a fraction and

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Match each percentage to a fraction and decimal: 25%, 50%, 75%, 10%, 30%.
...
**Coverage:** Online Year 5 task assessing match each percentage fraction decimal.
...
### P06 — Write 60 as tenths hundredths a decimal

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write 60% as tenths, hundredths, a decimal and a fraction.
...
**Coverage:** Online Year 5 task assessing write tenths hundredths decimal fraction.

### P07 — A class survey shows 20 out of

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A class survey shows 20 out of 100 students walk to school. What percentage is this?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing class survey shows students walk school percentage this.

### P08 — If 1 4 of a square is

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** If 1/4 of a square is shaded, what percentage is shaded? What percentage is unshaded?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing square shaded percentage shaded percentage unshaded.
...
### P12 — Fill in the blanks 0 1 100

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Fill in the blanks: 0.1 = ___% = ___/100.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing fill blanks.

### P13 — A water tank is 3 4 full

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A water tank is 3/4 full. What percentage is full? What percentage is empty?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing water tank full percentage full percentage empty.
...
### P16 — Order from smallest to largest 0 25
...
**Question:** Order from smallest to largest: 0.25, 30%, 1/5, 50%.
...
### P18 — Write three equivalent forms for 90 Include

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write three equivalent forms for 90%. Include a decimal and a fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write three equivalent forms include decimal fraction.

### P19 — A progress bar shows 45 How much

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A progress bar shows 45%. How much more is needed to reach 100%?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing progress shows much more needed reach.

### P20 — In a 100 square grid 68 squares

**Type:** Short response

**Delivery:** Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** In a 100-square grid, 68 squares are blue. Write the blue part as a percentage, decimal and fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing square grid squares blue write blue part percentage.

### P21 — Complete the structured template for a real

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the structured template for a real-life question involving 75% and solve it with a diagram.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing real life involving solve diagram.
...
### P25 — A jacket is 30 wool 45 cotton

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A jacket is 30% wool, 45% cotton and the rest polyester. What percentage is polyester?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing jacket wool cotton rest polyester percentage polyester.

### P26 — Order 0 72 7 10 75 0

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Order 0.72, 7/10, 75%, 0.705 and 3/4 from smallest to largest.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. The order must be complete and use the direction requested in the prompt.

**Coverage:** Online Year 5 task assessing order smallest largest.

### P27 — Which hundred grid correctly shows 62 shaded
...
**Coverage:** Online Year 5 task assessing hundred grid correctly shows shaded enter matching decimal.
...
### P30 — Find 10 25 and 50 of 240

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Find 10%, 25% and 50% of $240 using mental strategies.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing find mental strategies.

### P31 — A test has 40 questions Sam got

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A test has 40 questions. Sam got 85% correct. How many questions did Sam answer correctly?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing test questions correct many questions correctly.

### P32 — Match 0 25 50 75 and 100
...
**Coverage:** Online Year 5 task assessing match their decimal positions double number line.
...
### P34 — A survey shows 18 out of 60

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A survey shows 18 out of 60 students bike to school. Convert this to a percentage.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing survey shows students bike school convert this percentage.

## Tier 3 — Guided application

### P35 — A bar model is split into 35
...
**Coverage:** Online Year 5 task assessing model split into flowers vegetables missing section percentage.
...
### P38 — Fill the blanks 0 375 1000 3

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Fill the blanks: ___% = 0.375 = ___/1000 = 3/8.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing fill blanks 1000.

### P39 — In a game A scored 24 out

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** In a game, A scored 24 out of 30 and B scored 38 out of 50. Who had the higher percentage?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing game scored scored higher percentage.
...
### P43 — A class vote has 12 votes for

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A class vote has 12 votes for art, 8 for sport and 5 for music. What percentage chose each option?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing class vote votes sport music percentage chose each.
...
### P46 — A recipe is scaled to 150 What

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A recipe is scaled to 150%. What happens to each ingredient? Give an example.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing recipe scaled happens each ingredient example.
...
### P48 — Write a real life percentage problem where

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Write a real-life percentage problem where the answer must be interpreted carefully, then solve it.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write real life percentage problem must interpreted carefully.
...
### P51 — Complete the answer box Match each percentage

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Complete the answer box: Match each percentage to a fraction and decimal: 25%, 50%, 75%, 10%, 30%.
...
### P52 — Match or choose A phone battery is

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Match or choose: A phone battery is at 70%. What percentage has been used? Explain complementary percentages.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match phone battery percentage been used complementary percentages.
...
### P54 — Beginner digital question Write 60 as tenths

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Write 60% as tenths, hundredths, a decimal and a fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write tenths hundredths decimal fraction.

### P55 — Use the on screen options A class

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: A class survey shows 20 out of 100 students walk to school. What percentage is this?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing class survey shows students walk school percentage this.

### P56 — Complete the answer box If 1 4

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: If 1/4 of a square is shaded, what percentage is shaded? What percentage is unshaded?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing square shaded percentage shaded percentage unshaded.

### P57 — Match or choose use the on screen

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Show the required on-screen visual, model or widget; include an accessible text alternative. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: use the on-screen tool to build or select a bar model showing 40%, 60% and 100%.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match tool build model showing.
...
### P60 — Use the on screen options Fill in

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Use the on-screen options: Fill in the blanks: 0.1 = ___% = ___/100.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing fill blanks.

### P61 — Complete the answer box A water tank

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: A water tank is 3/4 full. What percentage is full? What percentage is empty?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing water tank full percentage full percentage empty.

### P62 — Match or choose Explain why 120 is

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Explain why 120% is more than one whole. Give a context where it could happen.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match more than whole context could happen.
...
### P64 — Beginner digital question Order from smallest to

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Beginner digital question: Order from smallest to largest: 0.25, 30%, 1/5, 50%.
...
### P66 — Complete the answer box Write three equivalent

**Type:** Short response

**Delivery:** Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Complete the answer box: Write three equivalent forms for 90%. Include a decimal and a fraction.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Use the platform answer key to store the exact accepted value, equivalent value or selected option.

**Coverage:** Online Year 5 task assessing write three equivalent forms include decimal fraction.

### P67 — Match or choose A progress bar shows

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: A progress bar shows 45%. How much more is needed to reach 100%?

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match progress shows much more needed reach.
...
**Question:** Beginner digital question: Complete the structured template for a real-life question involving 75% and solve it with a diagram.
...
### E04 — Match or choose Explain how percentages decimals

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Match or choose: Explain how percentages, decimals and fractions can all describe the same part of a whole.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing match percentages decimals fractions describe same part whole.

### E05 — Match 25 50 75 and 100 to

**Type:** Short response

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls.

**Question:** Match 25%, 50%, 75% and 100% to 1/4, 1/2, 3/4 and 1.
...
**Coverage:** Online Year 5 task assessing jacket wool cotton rest polyester percentage polyester check.

### E07 — Multi step online task Order 0 72

**Type:** Sequencing

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: Order 0.72, 7/10, 75%, 0.705 and 3/4 from smallest to largest. Use two steps and choose the matching reasoning.
...
**Coverage:** Online Year 5 task assessing reasoning check hundred grid correctly shows shaded enter.
...
**Coverage:** Online Year 5 task assessing find mental strategies check common trap before answering.

### E12 — Multi step online task A test has

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: A test has 40 questions. Sam got 85% correct. How many questions did Sam answer correctly? Use two steps and choose the matching reasoning.
...
**Coverage:** Online Year 5 task assessing reasoning check match their decimal positions double number.
...
### E17 — Multi step online task Explain why 1

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: Explain why 1/8 is 12.5%, even though Year 5 often starts with hundredths. Use two steps and choose the matching reasoning.
...
### E22 — Multi step online task A shirt is

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: A shirt is labelled 40% off. Explain two different ways to find the sale price if the original price is $50. Use two steps and choose the matching reasoning.
...
### E27 — Multi step online task A recipe is

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** Multi-step online task: A recipe is scaled to 150%. What happens to each ingredient? Give an example. Use two steps and choose the matching reasoning.
...
### E30 — A class score is 18 out of

**Type:** Matching

**Delivery:** Online, provide movable cards with drag, tap-to-place and keyboard controls. Place units outside numeric answer boxes and accept equivalent spacing or decimal formats.

**Question:** A class score is 18 out of 24. Convert it to a percentage and choose the matching decimal.

**Marking key:** Award credit for the mathematically correct response and for satisfying every stated condition. Each card must be matched to the representation with the same value or meaning.

**Coverage:** Online Year 5 task assessing class score convert percentage matching decimal.
