...
window.skillrTestQuestions = [
  ...
  },
  {
    ...
    "answers": [
      ...
      "Read “Before you lift the lid” as one group, pause, then read “switch off the machine”.",
  ...
  },
  {
    ...
    "responseInstructions": "Read aloud while an adult listens. If a word does not sound right, look through its letters, blend it and reread the sentence. Answer the short meaning check aloud; you may record the adult’s observations here.",
    "completionLabel": "I have read aloud; an adult still needs to check my reading.",
    "question": "The kite did not fall when the breeze faded. Its tail caught on a twig. We lowered the branch carefully and freed the tail before packing up.\n\nRead this whole passage aloud to an adult. Retain not and read the final actions in order. What held the kite up?",
    "audioPrompt": "The kite did not fall when the breeze faded. Its tail caught on a twig. We lowered the branch carefully and freed the tail before packing up.\n\nRead this whole passage aloud to an adult. Retain not and read the final actions in order. What held the kite up?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none"
