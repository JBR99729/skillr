...
window.skillrTestQuestions = [
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "Which response correctly uses recognise that in a table of values, if the second difference between consecutive values of the dependent variable is constant, then it is a quadratic?",
    "audioPrompt": "Which response correctly uses recognise that in a table of values, if the second difference between consecutive values of the dependent variable is constant, then it is a quadratic?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "Which response correctly uses graphing quadratic functions using digital tools and comparing what is the same and what is different between these different functions?",
    "audioPrompt": "Which response correctly uses graphing quadratic functions using digital tools and comparing what is the same and what is different between these different functions?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
