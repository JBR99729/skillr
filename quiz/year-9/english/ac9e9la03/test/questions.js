...
window.skillrTestQuestions = [
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During a fresh case study, Explain how one deliberate choice shapes meaning in examine how authors adapt and subvert text structures and language features by experimenting with spoken, written, visual and multimodal elements, and their combination Which response provides the strongest evidence?",
    "audioPrompt": "During a fresh case study, Explain how one deliberate choice shapes meaning in examine how authors adapt and subvert text structures and language features by experimenting with spoken, written, visual and multimodal elements, and their combination Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
