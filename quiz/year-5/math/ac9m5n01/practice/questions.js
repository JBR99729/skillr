...
window.quizQuestions = [
  {
    ...
    "answers": [
      "interpret, compare and order numbers with more than 2 decimal places,…",
    ...
    "correct": 0,
    "explanation": "This matches AC9M5N01: interpret, compare and order numbers with more than 2 decimal places,…."
  },
  {
    "id": "ac9m5n01-02",
    "type": "single",
  ...
  },
  {
    ...
    "answers": [
      ...
      "interpreting plans or diagrams showing length measures as decimals, placing…",
      "using a certain number of blocks to form different rectangles and using these…"
    ],
    "correct": 2,
    "explanation": "This matches AC9M5N01: interpret, compare and order numbers with more than 2 decimal places,…."
  },
  {
    ...
    "answers": [
      "researching divisibility tests and explaining each rule using materials; for…",
      "using divisibility tests to determine if larger numbers are multiples of…",
      "demonstrating and reasoning that all multiples can be formed by combining or…",
      "interpret, compare and order numbers with more than 2 decimal places,…"
    ],
    "correct": 3,
    "explanation": "This matches AC9M5N01: interpret, compare and order numbers with more than 2 decimal places,…."
