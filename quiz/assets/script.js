...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function setupMathsScratchpad() {
    ...
    document.addEventListener("keydown", (event) => {
      if (event.key === "Escape" && !layer.classList.contains("is-collapsed")) collapseScratchpad();
    });
