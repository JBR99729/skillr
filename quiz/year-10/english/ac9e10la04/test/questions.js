...
window.skillrTestQuestions = [
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During a worked solution audit, Explain how one deliberate choice shapes meaning in understand how paragraph structure can be varied to create cohesion, and paragraphs and images can be integrated for different purposes Which response provides the strongest evidence?",
    "audioPrompt": "During a worked solution audit, Explain how one deliberate choice shapes meaning in understand how paragraph structure can be varied to create cohesion, and paragraphs and images can be integrated for different purposes Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During a final synthesis, Explain how one deliberate choice shapes meaning in understand how paragraph structure can be varied to create cohesion, and paragraphs and images can be integrated for different purposes Which response provides the strongest evidence?",
    "audioPrompt": "During a final synthesis, Explain how one deliberate choice shapes meaning in understand how paragraph structure can be varied to create cohesion, and paragraphs and images can be integrated for different purposes Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
