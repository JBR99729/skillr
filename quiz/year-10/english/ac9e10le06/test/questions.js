...
window.skillrTestQuestions = [
  {
    "id": "ac9e10le06-t-001",
    "curriculumCode": "AC9E10LE06",
    "bank": "test",
    "skill": "a writer or speaker can use voice to shape comparing the voice of protest in a range of poems or songs and evaluating how different voices evoke a response and influence how an audience understands the text",
    "printable": true,
    "type": "single",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During an unfamiliar representation, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "audioPrompt": "During an unfamiliar representation, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During a worked solution audit, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "audioPrompt": "During a worked solution audit, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During a multi-step application, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "audioPrompt": "During a multi-step application, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "During a final synthesis, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "audioPrompt": "During a final synthesis, Explain how one deliberate choice shapes meaning in compare and evaluate how “voice” as a literary device is used in different types of texts, such as poetry, novels and film, to evoke emotional responses Which response provides the strongest evidence?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
