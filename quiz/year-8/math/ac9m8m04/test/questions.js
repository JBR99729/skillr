...
window.skillrTestQuestions = [
  {
    ...
    "printable": true,
    "type": "single",
    "question": "Which response correctly uses plan an international travel itinerary that covers destinations in different time zones across asia?",
    "audioPrompt": "Which response correctly uses plan an international travel itinerary that covers destinations in different time zones across asia?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "When would you use use digital tools to investigate time zones around the world and convert from one zone to another, such as time in perth?",
    "audioPrompt": "When would you use use digital tools to investigate time zones around the world and convert from one zone to another, such as time in perth?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "When would you use recognise the challenges of planning regular virtual meeting times for a company that has both international staff and staff within different states and territories?",
    "audioPrompt": "When would you use recognise the challenges of planning regular virtual meeting times for a company that has both international staff and staff within different states and territories?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
  ...
  },
  {
    ...
    "printable": true,
    "type": "single",
    "question": "When would you use plan an international travel itinerary that covers destinations in different time zones across asia?",
    "audioPrompt": "When would you use plan an international travel itinerary that covers destinations in different time zones across asia?",
    "visual": "",
    "visualHtml": "",
    "visualMeta": {
      "type": "none",
