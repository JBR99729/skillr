...
window.skillrPracticeQuestions = [
  {
    ...
    "bank": "practice",
    "sourceType": "Diagram",
    "question": "For AC9S8U01, inspect the diagram and identify one feature, part or process linked to recognise cells as the basic units of living things, compare.",
  ...
  },
  {
    ...
    "question": "For AC9S8U01, which explanation best matches recognise cells as the basic units of living things, compare: evidence-based cause, unrelated guess or decorative description?",
  ...
  },
  {
    ...
    "bank": "practice",
    "sourceType": "Sorting",
    "question": "For AC9S8U01, sort the example cards into 'matches recognise cells as the basic units of living things, compare' and 'does not match recognise cells as the basic units of living things, compare'.",
  ...
  },
  {
    ...
    "bank": "practice",
    "sourceType": "Matching",
    "question": "For AC9S8U01, match structure, function, process and evidence to part, job, change/action and observation/data.",
  ...
  },
  {
    ...
    "question": "For AC9S8U01, a results table shows values rising from 4 to 7 to 10. What pattern is shown?",
  ...
  },
  {
    ...
    "question": "For AC9S8U01, make one prediction about what would happen if a key condition changed.",
  ...
  },
  {
    ...
    "question": "For AC9S8U01, explain how evidence helps show what is happening in recognise cells as the basic units of living things, compare.",
  ...
  },
  {
    ...
    "bank": "practice",
    "sourceType": "Extended response",
    "question": "For AC9S8U01, a student gives an explanation that ignores the labelled diagram. Explain how to improve it.",
