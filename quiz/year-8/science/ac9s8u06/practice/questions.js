...
window.skillrPracticeQuestions = [
  {
    ...
    "bank": "practice",
    "sourceType": "Diagram",
    "question": "For AC9S8U06, inspect the diagram and identify one feature, part or process linked to classify matter as elements, compounds or mixtures and compare different.",
  ...
  },
  {
    ...
    "question": "For AC9S8U06, which explanation best matches classify matter as elements, compounds or mixtures and compare different: evidence-based cause, unrelated guess or decorative description?",
  ...
  },
  {
    ...
    "bank": "practice",
    "sourceType": "Sorting",
    "question": "For AC9S8U06, sort the example cards into 'matches classify matter as elements, compounds or mixtures and compare different' and 'does not match classify matter as elements, compounds or mixtures and compare different'.",
  ...
  },
  {
    ...
    "bank": "practice",
    "sourceType": "Matching",
    "question": "For AC9S8U06, match structure, function, process and evidence to part, job, change/action and observation/data.",
  ...
  },
  {
    ...
    "question": "For AC9S8U06, a results table shows values rising from 4 to 7 to 10. What pattern is shown?",
  ...
  },
  {
    ...
    "question": "For AC9S8U06, make one prediction about what would happen if a key condition changed.",
  ...
  },
  {
    ...
    "question": "For AC9S8U06, explain how evidence helps show what is happening in classify matter as elements, compounds or mixtures and compare different.",
  ...
  },
  {
    ...
    "bank": "practice",
    "sourceType": "Extended response",
    "question": "For AC9S8U06, a student gives an explanation that ignores the labelled diagram. Explain how to improve it.",
