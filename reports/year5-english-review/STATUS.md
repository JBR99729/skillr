...
## Rule
A code may be marked **FINISHED — DO NOT REPROCESS** only when all five components are complete and checked:
1. Topic Page
2. Classroom View
3. Worksheet/Homework
4. 48-question Practice bank
5. Separate 16-question Test bank

Future continuation runs must skip codes marked **FINISHED — DO NOT REPROCESS** unless the user explicitly asks to reopen them.
...
| AC9E5LE04 | PENDING | IXL-supported for imagery/figures; sound-device evidence limited |
| AC9E5LE05 | PENDING | Partial IXL evidence for full composition workflow |
| AC9E5LY03 | PENDING | IXL-supported |
| AC9E5LY05 | PENDING | IXL-supported; some named comprehension strategies not separately observed |
| AC9E5LY06 | PENDING | Partial IXL evidence for full drafting/publishing/multimodal workflow |
| AC9E5LY08 | PENDING | Partial IXL evidence for common-pattern/different-pronunciation demand |
