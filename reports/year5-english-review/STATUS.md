# Year 5 English — production completion status

Last updated: 9 September 2026

## Rule
A code may be marked **FINISHED — DO NOT REPROCESS** only when all five components are complete and checked: Topic Page, Classroom View, Worksheet/Homework, 48-question Practice bank, separate 16-question Test bank. Future continuation runs must skip finished codes unless the user explicitly reopens them.

## IXL-evidence-supported production batch
| Code | Status | Notes |
|---|---|---|
| AC9E5LA02 | **FINISHED — DO NOT REPROCESS** | 48/16 + all teaching surfaces; authoritative-source/counterclaim IXL limit disclosed. |
| AC9E5LA03 | **FINISHED — DO NOT REPROCESS** | 48/16 + all teaching surfaces; spoken/multimodal limit disclosed. |
| AC9E5LA04 | **FINISHED — DO NOT REPROCESS** | 48/16 + all teaching surfaces; conjunction evidence separated from prominence extension. |
| AC9E5LA05 | **FINISHED — DO NOT REPROCESS** | 48/16 + all teaching surfaces; complex sentences and clause-order effects. |
