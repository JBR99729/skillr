...
Published 5f27349cdf0c6649b2574c8873c16438ce9535ba, complete tree f8d0285b145d340629cde96f761f88d2117143be matched local tree. Integrity 18,245 →18,248 files, zero deletions, core/CNAME intact. Remote base reread/non-force update; seven Actions and Pages all succeeded. Live Practice and Test rendered personal-response tasks. Model-generated QA examples saved as pending (not actual student autobiographical claims); Practice displayed flexible guidance and Test withheld the model. A Test response deliberately preferred the alternative to the model, and remained pending for human judgement rather than being marked wrong. Homepage loaded. The full unchanged adult-marking flow was exercised in LE04; not repeated in full here. Audio playback untested.

Small follow-up prepared with LE05: remove redundant “Example response:” prefix from model_answer because the unchanged Practice runtime already supplies “Example:”. Source, draft, runtime mirrors and question-cache versions updated together; questions/keys unchanged.
