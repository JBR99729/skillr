(() => {
  ...
  const routes = [
    ...
    [/^\/year2\/science\/ac9s2/i, [...year2ScienceData, "/assets/year2-science-render.js?v=2"]],
    [/^\/quiz\/year-2\/science\/ac9s2[a-z0-9]+\/(practice|test)\/?$/i, [...year2ScienceData, "/assets/year2-science-practice-quick-read.js?v=2"]],
