...
During publication, main advanced to `55c03d9e48cf62a5a881baa611b4d1fcdb3f00e2` with a separately approved Year 1 visual-bank import. This release preserves that import and its dedicated worksheet-bank scripts. The 15 Year 1 Maths worksheet pages combine the current bank integration with this release's authored support and PDF version 18. Run the release validator with `python scripts/validate_learning_quality_refresh.py 55c03d9e48cf62a5a881baa611b4d1fcdb3f00e2` to compare only this release's changes.
