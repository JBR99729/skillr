...
## Supporting navigation and destination correction

The owner subsequently asked to highlight videos while protecting the value and prominence of the written guides. The follow-up adds a small “Need another explanation? Watch a video” link after the existing header resources and a “Back to the lesson” link within the video section. The guide, its wording and resource order remain intact. No claim is made that this will increase engagement or prevent learners from choosing video first.

This check also identified 32 older inventory addresses that redirect to actual Year 8–10 Science lessons. The original count of 666 referred to inventory addresses: 32 supplements were on redirect stubs, so only 634 actual destination lessons had them. The follow-up resolves those existing same-code destinations, places their selected videos on the real lesson pages and removes only the obsolete video blocks from the redirect stubs. It preserves all existing redirects and canonical metadata. The corrected destination coverage is 666 of 676 actual lessons.

Independent comparison confirmed exact authored-content preservation across all 676 real lessons and 32 redirect stubs. Five focused regression checks passed, including rejection of ambiguous or cross-code redirects. The video catalogue and teaching selections are unchanged. The existing audiovisual-review and Google-designation limits still apply.
