...
## 0. Locked Topic Guide + Teacher Slide standard (v1)

This is the minimum acceptance standard for every new or rebuilt curriculum code. Older resources can be migrated in batches, but a code must not be described as **Topic Guide + Teacher Slide v1 complete** until both resources pass this standard.
...
6. At least one worked teaching example with clear teacher language.
7. Topic-specific misconceptions with rapid corrective actions.
8. A short, practical warm-up, game, investigation or group activity.
9. A quick mastery check that assesses what the page taught.
10. An embedded live teacher-slide preview and a full-screen link.
11. Formal curriculum wording and references kept available without dominating the main teaching flow.
12. Links to the worksheet, Practice and Test resources.
...
Simple SVG diagrams, clean icons and functional illustrations are acceptable. Stock imagery is optional and must not replace a required mathematical, scientific or explanatory model.
...
- Store one unique structured lesson specification per curriculum code.
