(() => {
  ...
  async function init() {
    try {
      ...
      if (meta) meta.content = `${code} Year 2 Science worksheet with a core sheet and optional enrichment extension.`;
