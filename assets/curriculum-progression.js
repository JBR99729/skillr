(() => {
  ...
  const PROGRESSION = {
    ...
    AC9SFU01: { practice:'/quiz/grade-k/science/ac9sfu01/practice/', up:'/year1/science/ac9s1u01-needs-of-plants-and-animals/', upTitle:'Year 1: Needs of plants and animals', upText:'Extend observable external features into what plants and animals need to live and grow.' },
    AC9SFU02: { practice:'/quiz/grade-k/science/ac9sfu02/practice/', up:'/year1/science/ac9s1u03-pushes-and-pulls/', upTitle:'Year 1: Pushes and pulls', upText:'Build from observing how objects move to describing how pushes and pulls change movement.' },
    AC9SFU03: { practice:'/quiz/grade-k/science/ac9sfu03/practice/', up:'/year2/science/ac9s2u03-that-materials-can-be-changed-physically-without-changing-their/', upTitle:'Year 2: Physical changes to materials', upText:'Extend observable material properties into investigating how materials can be physically changed while remaining the same material.' },
    AC9SFH01: { practice:'/quiz/grade-k/science/ac9sfh01/practice/', up:'/year1/science/ac9s1h01-science-in-daily-life/', upTitle:'Year 1: Science in daily life', upText:'Extend observing and asking questions about the world into recognising how science is used in everyday life.' },
    AC9SFI01: { practice:'/quiz/grade-k/science/ac9sfi01/practice/', up:'/year1/science/ac9s1i01-questions-patterns-and-predictions/', upTitle:'Year 1: Questions, patterns and predictions', upText:'Build from experience-based questions and predictions to using observed patterns to make predictions.' },
    AC9SFI02: { practice:'/quiz/grade-k/science/ac9sfi02/practice/', up:'/year1/science/ac9s1i02-safe-investigation-procedures/', upTitle:'Year 1: Safe investigation procedures', upText:'Extend guided safe investigations into following simple procedures and using tools appropriately.' },
    AC9SFI03: { practice:'/quiz/grade-k/science/ac9sfi03/practice/', up:'/year1/science/ac9s1i04-sorting-data-and-representing-patterns/', upTitle:'Year 1: Sort data and represent patterns', upText:'Extend provided observation templates and guided pattern finding into sorting data and representing observed patterns.' },
    AC9SFI04: { practice:'/quiz/grade-k/science/ac9sfi04/practice/', up:'/year1/science/ac9s1i05-comparing-observations-and-predictions/', upTitle:'Year 1: Compare observations and predictions', upText:'Move from comparing predictions with observations under guidance to explaining similarities and differences using evidence.' },
    AC9SFI05: { practice:'/quiz/grade-k/science/ac9sfi05/practice/', up:'/year1/science/ac9s1i06-communicating-scientific-ideas/', upTitle:'Year 1: Communicate scientific ideas', upText:'Extend sharing questions, predictions, observations and ideas into communicating findings and scientific ideas more deliberately.' }
  };
