(function () {
  ...
  function renderSteps(steps) {
    return steps.map(function (step) {
      return '<li><span class="skillr-first-visit__step" aria-hidden="true"></span><span><strong>' + escapeHtml(step[0]) + '</strong> ' + escapeHtml(step[1]) + '</span></li>';
    }).join("");
  }
