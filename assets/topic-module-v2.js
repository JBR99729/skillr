    ...
    <div class="skillr-discussion__body">
      <div class="skillr-discussion__grid">
        ...
        <form class="skillr-discussion__panel" data-discussion-form>
          ...
          <p class="skillr-discussion__note"><strong>Prototype:</strong> submissions are stored only in this browser for now. They are not public or sent to SkillrHub yet. Do not include your full name, school, email, phone number or other personal information.</p>
        </form>
      </div>
    </div>`;
