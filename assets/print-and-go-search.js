(function () {
  ...
  function card(product) {
    ...
    article.append(link, element('p', product.curriculumCodes.join(' · '), 'small'), element('p', product.description), element('p', new Intl.NumberFormat('en-AU', {style: 'currency', currency: product.currency}).format(Number(product.price)), 'price'), details);
    return article;
  }
  function render() {
