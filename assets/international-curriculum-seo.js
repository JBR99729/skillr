(function(){
  ...
  var AU_EXACT={
    ...
    AC9M1SP02:{vic:'VC2M1SP02',nsw:'MA1-GM-01',note:'giving and following directions and describing position and movement in familiar environments; closest NSW Stage 1 position outcome'},
    AC9M1ST01:{vic:'VC2M1ST01',nsw:'MA1-DATA-01',note:'collecting, organising and representing categorical data and interpreting simple data displays; closest NSW Stage 1 data outcome'},
    AC9SFU01:{vic:'VCSSU042',nsw:'STE-SCI-01',note:'external features and characteristics of living things; NSW Early Stage 1 science outcome'},
    AC9SFU02:{vic:'VCSSU048',nsw:'STE-SCI-01',note:'movement of objects and observable factors that affect movement; NSW Early Stage 1 science outcome'},
    AC9SFU03:{vic:'VCSSU044',nsw:'STE-SCI-01',note:'observable properties of materials and objects; NSW Early Stage 1 science outcome'},
    AC9SFH01:{vic:'VCSSU041',nsw:'STE-PQU-01',note:'using observations and questions to learn about the natural world; closest NSW Early Stage 1 questioning outcome'},
    AC9SFI01:{vic:'VCSIS050',nsw:'STE-PQU-01',note:'posing questions from observations and making predictions about familiar objects and events'},
    AC9SFI02:{vic:'VCSIS051',nsw:'STE-PQU-01 + STE-SCI-01',note:'guided investigations and observations using senses and simple tools; NSW embeds investigation practices with science content'},
    AC9SFI03:{vic:'VCSIS052 + VCSIS053',nsw:'STE-PQU-01',note:'recording and sorting observations to identify simple patterns; closest NSW Early Stage 1 inquiry outcome'},
    AC9SFI04:{vic:'VCSIS054',nsw:'STE-PQU-01',note:'comparing observations and predictions with guidance; closest NSW Early Stage 1 inquiry outcome'},
    AC9SFI05:{vic:'VCSIS055',nsw:'STE-PQU-01',note:'representing and communicating observations, questions and ideas from investigations'}
  };
