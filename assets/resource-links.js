(function () {
  ...
  function init() {
    ...
    css.rel = 'stylesheet'; css.href = '/assets/resource-links.css?v=1';
    document.head.appendChild(css);
    const menu = document.createElement('details');
    menu.id = 'skillr-resource-links';
    menu.innerHTML = '<summary>Teaching resources</summary><nav aria-label="Teaching resource shortcuts"><a href="/print-and-go.html">Print &amp; Go<span>Printable practice packs</span></a><a href="/teach-and-explain.html">Teach &amp; Explain<span>Slides for teachers &amp; parents</span></a></nav>';
