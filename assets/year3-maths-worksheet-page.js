(() => {
  ...
  function renderScreen(unit, worksheet) {
    ...
    const selected=practiceNumber===1?all.slice(0,5):all.slice(5);
  ...
  async function init() {
    try {
      ...
      const meta=document.querySelector('meta[name="description"]'); if(meta)meta.content=`${code} Year 3 Maths Topic Practice ${practiceNumber}, one of two printable sheets partitioning nine aligned questions with its own answer key.`;
