(() => {
  ...
  async function init() {
    try {
      ...
      const meta=document.querySelector('meta[name="description"]'); if(meta)meta.content=`${code} Year 3 Maths worksheet with 8 core questions and a separate 2-question enrichment extension.`;
