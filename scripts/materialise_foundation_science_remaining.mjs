...
import {test as sfu03Test} from'./foundation_science_actual/ac9sfu03_test_authored.mjs';
const root=process.cwd();
const banks={AC9SFI03:[sfi03,'record observations and identify patterns'],AC9SFI04:[sfi04,'compare observations with predictions'],AC9SFI05:[{practice:sfi05.practice,test:sfi05Test},'share science questions predictions observations and ideas'],AC9SFU01:[sfu01,'observe and group plant and animal external features'],AC9SFU02:[sfu02,'describe how size shape and material influence movement'],AC9SFU03:[{practice:sfu03.practice,test:sfu03Test},'recognise objects materials and observable properties']};
