...
<details class="curriculum-topic-section"><summary><strong>See it, then try it</strong></summary><div class="curriculum-detail-body"><h3>${esc(unit.model_title)}</h3>${unit.model_html||""}<article class="curriculum-worked-example"><h3>Worked example</h3><p>${esc(unit.solved_example||unit.learn)}</p></article><h3>${esc(unit.apply_title)}</h3>${unit.apply_html||""}</div></details>
...
console.log(`Rebuilt ${codes.length} static Year 2 English topic guides while preserving Classroom Views unchanged.`);
