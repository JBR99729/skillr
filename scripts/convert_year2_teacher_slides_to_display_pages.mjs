...
<header class="display-header"><div><p>Year 2 ${esc(titleCaseSubject(subject))}</p><h1 id="page-title">${esc(code)} - ${esc(title)}</h1><small>Teacher Display Page - plain HTML, landscape-friendly</small></div><p>Open one section at a time</p></header>
