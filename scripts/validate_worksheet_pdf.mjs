...
banks.window={};
const groupedBank='quiz/year-1/math/ac9m1n06/worksheet/questions.js';
vm.runInContext(fs.readFileSync(path.join(root,fs.existsSync(path.join(root,groupedBank))?groupedBank:'quiz/year-1/math/ac9m1n06/practice/questions.js'),'utf8'),banks);
