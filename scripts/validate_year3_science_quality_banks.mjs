...
const BANK_ROOT = path.join(ROOT, "assets", "assessment-banks", "year3", "science");
const codes = ["AC9S3U01", "AC9S3U02", "AC9S3U03", "AC9S3U04", "AC9S3H01", "AC9S3H02", "AC9S3I01", "AC9S3I02", "AC9S3I03", "AC9S3I04", "AC9S3I05", "AC9S3I06"];
const problems = [];
...
for (const script of ["scripts/build_year3_science_quality_banks.mjs", "scripts/publish_year3_science_quality_banks.mjs", "scripts/validate_year3_science_quality_banks.mjs"]) {
