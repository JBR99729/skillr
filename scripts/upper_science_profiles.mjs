const p=(title,subtitle,strand,component,labels,progression,worked,misconceptions,warmUp,mustTeach,mustNot)=>({title,subtitle,strand,component,labels,progression,worked,misconceptions,warmUp,mustTeach,mustNot});
