...
for (const file of ["assets/year5-curriculum-base.js", "assets/year5-maths-data-n1.js", "assets/year5-maths-data-n2.js", "assets/year5-maths-data-am.js", "assets/year5-maths-data-spstp.js"]) {
...
for (const code of order) {
  ...
  execFileSync(process.execPath, ["scripts/publish_production_question_bank.mjs", `assets/assessment-banks/year5/math/${lower}.json`], { cwd: ROOT, stdio: "inherit" });
  const route = path.join(ROOT, "quiz", "year-5", "math", lower);
  ...
  for (const bank of ["practice", "test"]) {
    ...
    html = html
      ...
      .replace(/<script src="[^"]*\/practice\/questions\.js(?:\?[^"]*)?"><\/script>/, `<script src="/quiz/year-5/math/${lower}/${bank}/questions.js?v=20260813-production-v1"></script>`)
