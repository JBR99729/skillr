...
for (const script of ["scripts/build_year2_science_quality_banks.mjs", "scripts/publish_year2_science_quality_banks.mjs", "scripts/validate_year2_science_quality_banks.mjs"]) {
