...
<header class="curriculum-hero"><p class="curriculum-eyebrow">${htmlEscape(code)} • Year ${year} Maths${strand ? ` • ${htmlEscape(strand)}` : ''}</p><h1>${htmlEscape(title)}</h1><p class="curriculum-hero__lead">${htmlEscape(subtitle || contentDescription || '')}</p><div class="topic-action-row"><a class="primary" href="#topic-guide">Topic Guide</a><a href="teacher-slides/">Classroom View</a><a href="${resourceUrl(year, code, 'worksheet')}">Practice Sheet</a><a href="${resourceUrl(year, code, 'practice')}">Practice</a><a href="${resourceUrl(year, code, 'test')}">Test</a></div></header>
<main class="curriculum-layout${year >= 9 ? ' curriculum-layout--single' : ''}"><div id="topic-guide">
...
<details class="curriculum-topic-section"><summary><strong>Resources</strong></summary><div class="curriculum-detail-body"><div class="curriculum-link-row"><a class="curriculum-button primary" href="teacher-slides/">Open Classroom View</a><a class="curriculum-button" href="${resourceUrl(year, code, 'worksheet')}">Practice Sheet</a><a class="curriculum-button" href="${resourceUrl(year, code, 'practice')}">Practice</a><a class="curriculum-button" href="${resourceUrl(year, code, 'test')}">Test</a></div></div></details>
</div><aside class="curriculum-sidebar"><section class="curriculum-panel"><h2>Teacher resource</h2><p>Project the fixed branded deck one slide at a time.</p><a class="curriculum-button primary" href="teacher-slides/">Classroom View</a></section><section class="curriculum-panel"><h2>Curriculum code</h2><p><strong>${htmlEscape(code)}</strong><br>Year ${year} Mathematics${strand ? ` • ${htmlEscape(strand)}` : ''}</p></section></aside></main>
