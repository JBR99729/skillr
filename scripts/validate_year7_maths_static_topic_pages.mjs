...
if (!/\.curriculum-page:has\(\.breadcrumb a\[href="\/year7\/curriculum\/maths\/"\]\) \.curriculum-layout>\.curriculum-sidebar\{display:none\}/.test(css)) failures.push('assets/year7-curriculum.css: Year 7 Maths sidebar must be hidden for single-column reading');
