...
const baseDirs = ["year8/english", "year8/maths", "year8/science"];
...
<header class="display-header"><div><p>Year 8 ${esc(titleCaseSubject(subject))}</p><h1 id="page-title">Classroom View</h1><small>Ready to project and teach</small><p class="display-topic-title">${esc(code)} - ${esc(title)}</p><!-- Teacher Display Page --></div><p>Open one section at a time</p></header>
...
for (const file of files) {
  ...
  if (/<meta[^>]+http-equiv=["']refresh["']/i.test(topicHtml) && movedCanonical?.startsWith("https://skillrhub.com/year8/")) {
...
console.log(`Converted ${changed} Year 8 teacher slide files to display pages. Skipped ${skipped}.`);
