...
const codes = ["ac9efly12", "ac9efly13", "ac9efly14", "ac9efly15"];
const version = "20260906-foundation-english-ly12-ly15-ixl-standard";
...
console.log("PASS: Foundation English AC9EFLY12-AC9EFLY15 hold 24/16 IXL-standard banks with targeted visuals and rotating 8/12 attempts.");
