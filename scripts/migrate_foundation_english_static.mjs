...
<header class="curriculum-hero"><p class="curriculum-eyebrow">${esc(code)} • Foundation English</p><h1>${esc(unit.title)}</h1><p class="curriculum-hero__lead">${esc(unit.learn || unit.desc || spec.contentDescription || '')}</p><div class="topic-action-row"><a class="primary" href="#topic-guide">Topic Guide</a><a href="teacher-slides/">Classroom View</a><a href="${quizRoute(code,'worksheet')}">Practice Sheet</a><a href="${quizRoute(code,'practice')}">Practice</a><a href="${quizRoute(code,'test')}">Test</a></div></header>
