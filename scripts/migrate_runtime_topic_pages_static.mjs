...
function buildYear3Main(code, u, html, allCodes, units) {
  ...
  const sections = [
    ...
    details('resources', 'Practice and teaching resources', `<div class="curriculum-link-row"><a class="curriculum-button primary" href="teacher-slides/">Classroom View</a><a class="curriculum-button" href="${q('worksheet')}">Practice Sheet</a><a class="curriculum-button" href="${q('practice')}">Practice</a><a class="curriculum-button" href="${q('test')}">Test</a></div>`),
...
function migrateYear3() {
  ...
  for (const code of allCodes) {
    ...
    html = html.replace(/<div class="topic-action-row">[\s\S]*?<\/div>/i, `<div class="topic-action-row"><a class="primary" href="#learn">Start lesson</a><a href="teacher-slides/">Classroom View</a><a href="/quiz/year-3/math/${code.toLowerCase()}/worksheet/">Practice Sheet</a><a href="/quiz/year-3/math/${code.toLowerCase()}/practice/">Practice</a><a href="/quiz/year-3/math/${code.toLowerCase()}/test/">Test</a></div>`);
...
function migrateFoundationScience() {
  ...
  const sections = [
    ...
    details('resources','Practice and teaching resources','<div class="curriculum-link-row"><a class="curriculum-button primary" href="teacher-slides/">Classroom View</a><a class="curriculum-button" href="/quiz/grade-k/science/ac9sfu03/worksheet/">Worksheet</a><a class="curriculum-button" href="/quiz/grade-k/science/ac9sfu03/practice/">Practice</a><a class="curriculum-button" href="/quiz/grade-k/science/ac9sfu03/test/">Test</a></div>'),
  ...
  html = html.replace(/<div class="topic-action-row">[\s\S]*?<\/div>/i, '<div class="topic-action-row"><a class="primary" href="#learn">Start lesson</a><a href="teacher-slides/">Classroom View</a><a href="/quiz/grade-k/science/ac9sfu03/worksheet/">Worksheet</a><a href="/quiz/grade-k/science/ac9sfu03/practice/">Practice</a><a href="/quiz/grade-k/science/ac9sfu03/test/">Test</a></div>');
  html = html.replace(/<main class="curriculum-layout">[\s\S]*?<\/main>/i, main);
  fs.writeFileSync(file, html);
