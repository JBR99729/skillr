...
def page_title(source,path):
 for tag in ("h1","title"):
  ...
  if m:
   ...
   text=re.sub(r"\s*[|–-]\s*(SkillrHub|SkillrHub)\s*$","",text,flags=re.I)
   if text:return text
