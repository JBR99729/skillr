...
def attempt(mode):
    ...
    config = f'''window.quizConfig={{storageKey:"AC9M1N01{label}Best",skillCode:"AC9M1N01",maxQuestions:5,shuffleQuestions:true,shuffleAnswers:true,questionCycle:false,preReadSeconds:0,requireStudentName:{str(mode == 'test').lower()},passingPercent:75,resultStorageKey:"{key}",resultUrl:"result/",reviewUrl:"../review/",retakeUrl:"../retake/"}};'''
