...
function analyse(file) {
  ...
  return {file, html, code, subjectLabel, title, canonical, description, learning, elaborations, teachingExamples, qa, assessmentQuestions, reviewHints, exitItems, missing};
}
...
function viewer(unit) {
  ...
  return `<!doctype html><html lang="en-AU"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,follow"><title>${esc(unit.code)} Teacher Slides | SkillrHub</title><link rel="canonical" href="${esc(unit.canonical)}"><link rel="stylesheet" href="/style.css"><link rel="stylesheet" href="/assets/teacher-slide-viewer.css?v=1"><style>
